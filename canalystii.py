...
class CANalystIIBus(BusABC):
    def __init__(self, channel, bitrate=None, Timing0=None, Timing1=None, can_filters=None):
 #   def __init__(self, channel, device=0, bitrate=None, Timing0=None, Timing1=None, can_filters=None):
        """

        :param channel: channel number
        :param device: device number
        :param bitrate: bitrate rate
       ...
       # self.device = device
        ...
        self.channel_info = "CANalyst-II: channels {}".format(self.channels)
        bitrate = int(bitrate)
        ...
        self.init_config = VCI_INIT_CONFIG(0x80000008, 0xFFFFFFFF, 0, 1, Timing0, Timing1, 0)
        ...
        for channel in self.channels:
            ...
            if CANalystII.VCI_ClearBuffer(VCI_USBCAN2, 0, channel) ==STATUS_ERR:
                logger.error("VCI_ClearBuffer Error")
                self.shutdown()
                return
    ...
    def send(self, msg, timeout=None):
        ...
        raw_message = VCI_CAN_OBJ(msg.arbitration_id, 0, 0, 0, msg.is_remote_frame, extern_flag, msg.dlc, (c_ubyte * 8)(*msg.data), (c_byte * 3)(*[0, 0, 0]))
    ...
    def flush_tx_buffer(self):
        for channel in self.channels:
            CANalystII.VCI_ClearBuffer(VCI_USBCAN2, 0, channel)
